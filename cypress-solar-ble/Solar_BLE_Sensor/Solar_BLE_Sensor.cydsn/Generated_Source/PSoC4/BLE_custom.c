...
const CYBLE_CUSTOMS_T cyBle_customs[0x01u] = {
    ...
    {
        0x000Cu, /* Handle of the Eddystone-URL Configuration service */ 
        {

            /* Lock State characteristic */
            {
                0x000Eu, /* Handle of the Lock State characteristic */ 
            ...
            /* Lock characteristic */
            {
                0x0010u, /* Handle of the Lock characteristic */ 
            ...
            {
                0x0012u, /* Handle of the Unlock characteristic */ 
            ...
            {
                0x0014u, /* Handle of the URI Data characteristic */ 
            ...
            {
                0x0016u, /* Handle of the URI Flags characteristic */ 
            ...
            {
                0x0018u, /* Handle of the Advertised Tx Power Levels characteristic */ 
            ...
            {
                0x001Au, /* Handle of the Tx Power Mode characteristic */ 
            ...
            {
                0x001Cu, /* Handle of the Beacon Period characteristic */ 
            ...
            {
                0x001Eu, /* Handle of the Reset characteristic */ 
