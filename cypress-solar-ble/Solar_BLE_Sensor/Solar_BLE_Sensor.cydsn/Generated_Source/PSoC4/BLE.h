...
#define CYBLE_GAP_ROLE_BROADCASTER                  (0u != (CYBLE_GAP_ROLE & CYBLE_GAP_BROADCASTER))
    ...
    #define CYBLE_FAST_ADV_TIMEOUT                  (0x003Cu)
...
/* Tx Power Level */
#define CYBLE_TX_POWER_LEVEL_ADV                    (CYBLE_LL_PWR_LVL_NEG_2_DBM)
#define CYBLE_TX_POWER_LEVEL_CONN                   (CYBLE_LL_PWR_LVL_NEG_2_DBM)

#define CYBLE_ADV_PKT_INDEX_FLAGS   (0x00u)
#define CYBLE_ADV_PKT_INDEX_TX_POWER_LEVEL   (0x03u)
#define CYBLE_ADV_PKT_INDEX_SERVICE_UUID_128   (0x06u)
...
#define CYBLE_GATT_MAX_ATTR_LEN             ((0x0012u == 0u) ? (1u) : (0x0012u))
