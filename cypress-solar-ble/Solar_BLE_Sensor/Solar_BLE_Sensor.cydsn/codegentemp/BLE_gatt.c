    ...
    const CYBLE_GATTS_T cyBle_gatts =
{
    ...
    static uint8 cyBle_attValues[0x5Au] = {
    /* Device Name */
    (uint8)'S', (uint8)'o', (uint8)'l', (uint8)'a', (uint8)'r', (uint8)' ', (uint8)'B', (uint8)'L', (uint8)'E', (uint8)' ',
(uint8)'S', (uint8)'e', (uint8)'n', (uint8)'s', (uint8)'o', (uint8)'r', 
...
const uint8 cyBle_attUuid128[][16u] = {
    ...
    { 0xD8u, 0x81u, 0xC9u, 0x1Au, 0xB9u, 0x99u, 0x96u, 0xABu, 0xBAu, 0x40u, 0x86u, 0x87u, 0x80u, 0x20u, 0x0Cu, 0xEEu },
    /* Lock State */
    { 0xD8u, 0x81u, 0xC9u, 0x1Au, 0xB9u, 0x99u, 0x96u, 0xABu, 0xBAu, 0x40u, 0x86u, 0x87u, 0x81u, 0x20u, 0x0Cu, 0xEEu },
    /* Lock */
    { 0xD8u, 0x81u, 0xC9u, 0x1Au, 0xB9u, 0x99u, 0x96u, 0xABu, 0xBAu, 0x40u, 0x86u, 0x87u, 0x82u, 0x20u, 0x0Cu, 0xEEu },
    /* Unlock */
    { 0xD8u, 0x81u, 0xC9u, 0x1Au, 0xB9u, 0x99u, 0x96u, 0xABu, 0xBAu, 0x40u, 0x86u, 0x87u, 0x83u, 0x20u, 0x0Cu, 0xEEu },
    /* URI Data */
    { 0xD8u, 0x81u, 0xC9u, 0x1Au, 0xB9u, 0x99u, 0x96u, 0xABu, 0xBAu, 0x40u, 0x86u, 0x87u, 0x84u, 0x20u, 0x0Cu, 0xEEu },
    /* URI Flags */
    { 0xD8u, 0x81u, 0xC9u, 0x1Au, 0xB9u, 0x99u, 0x96u, 0xABu, 0xBAu, 0x40u, 0x86u, 0x87u, 0x85u, 0x20u, 0x0Cu, 0xEEu },
    /* Advertised Tx Power Levels */
    { 0xD8u, 0x81u, 0xC9u, 0x1Au, 0xB9u, 0x99u, 0x96u, 0xABu, 0xBAu, 0x40u, 0x86u, 0x87u, 0x86u, 0x20u, 0x0Cu, 0xEEu },
    /* Tx Power Mode */
    { 0xD8u, 0x81u, 0xC9u, 0x1Au, 0xB9u, 0x99u, 0x96u, 0xABu, 0xBAu, 0x40u, 0x86u, 0x87u, 0x87u, 0x20u, 0x0Cu, 0xEEu },
    /* Beacon Period */
    { 0xD8u, 0x81u, 0xC9u, 0x1Au, 0xB9u, 0x99u, 0x96u, 0xABu, 0xBAu, 0x40u, 0x86u, 0x87u, 0x88u, 0x20u, 0x0Cu, 0xEEu },
    /* Reset */
    { 0xD8u, 0x81u, 0xC9u, 0x1Au, 0xB9u, 0x99u, 0x96u, 0xABu, 0xBAu, 0x40u, 0x86u, 0x87u, 0x89u, 0x20u, 0x0Cu, 0xEEu },
};

CYBLE_GATTS_ATT_GEN_VAL_LEN_T cyBle_attValuesLen[CYBLE_GATT_DB_ATT_VAL_COUNT] = {
    { 0x0010u, (void *)&cyBle_attValues[0] }, /* Device Name */
    { 0x0002u, (void *)&cyBle_attValues[16] }, /* Appearance */
    { 0x0008u, (void *)&cyBle_attValues[18] }, /* Peripheral Preferred Connection Parameters */
    { 0x0004u, (void *)&cyBle_attValues[26] }, /* Service Changed */
    { 0x0002u, (void *)&cyBle_attValuesCCCD[0] }, /* Client Characteristic Configuration */
    { 0x0010u, (void *)&cyBle_attUuid128[0] }, /* Eddystone-URL Configuration UUID */
    { 0x0010u, (void *)&cyBle_attUuid128[1] }, /* Lock State UUID */
    { 0x0001u, (void *)&cyBle_attValues[30] }, /* Lock State */
    { 0x0010u, (void *)&cyBle_attUuid128[2] }, /* Lock UUID */
    { 0x0010u, (void *)&cyBle_attValues[31] }, /* Lock */
    { 0x0010u, (void *)&cyBle_attUuid128[3] }, /* Unlock UUID */
    { 0x0010u, (void *)&cyBle_attValues[47] }, /* Unlock */
    { 0x0010u, (void *)&cyBle_attUuid128[4] }, /* URI Data UUID */
    { 0x0012u, (void *)&cyBle_attValues[63] }, /* URI Data */
    { 0x0010u, (void *)&cyBle_attUuid128[5] }, /* URI Flags UUID */
    { 0x0001u, (void *)&cyBle_attValues[81] }, /* URI Flags */
    { 0x0010u, (void *)&cyBle_attUuid128[6] }, /* Advertised Tx Power Levels UUID */
    { 0x0004u, (void *)&cyBle_attValues[82] }, /* Advertised Tx Power Levels */
    { 0x0010u, (void *)&cyBle_attUuid128[7] }, /* Tx Power Mode UUID */
    { 0x0001u, (void *)&cyBle_attValues[86] }, /* Tx Power Mode */
    { 0x0010u, (void *)&cyBle_attUuid128[8] }, /* Beacon Period UUID */
    { 0x0002u, (void *)&cyBle_attValues[87] }, /* Beacon Period */
    { 0x0010u, (void *)&cyBle_attUuid128[9] }, /* Reset UUID */
    { 0x0001u, (void *)&cyBle_attValues[89] }, /* Reset */
};
...
const CYBLE_GATTS_DB_T cyBle_gattDB[0x1Eu] = {
    ...
    { 0x0003u, 0x2A00u /* Device Name                         */, 0x00000201u /* rd     */, 0x0003u, {{0x0010u, (void *)&cyBle_attValuesLen[0]}} },
    ...
    { 0x000Cu, 0x2800u /* Primary service                     */, 0x00080001u /*        */, 0x001Eu, {{0x0010u, (void *)&cyBle_attValuesLen[5]}} },
    { 0x000Du, 0x2803u /* Characteristic                      */, 0x00000201u /* rd     */, 0x000Eu, {{0x0010u, (void *)&cyBle_attValuesLen[6]}} },
    { 0x000Eu, 0x2081u /* Lock State                          */, 0x00090201u /* rd     */, 0x000Eu, {{0x0001u, (void *)&cyBle_attValuesLen[7]}} },
    { 0x000Fu, 0x2803u /* Characteristic                      */, 0x00000801u /* wr     */, 0x0010u, {{0x0010u, (void *)&cyBle_attValuesLen[8]}} },
    { 0x0010u, 0x2082u /* Lock                                */, 0x00090802u /* wr     */, 0x0010u, {{0x0010u, (void *)&cyBle_attValuesLen[9]}} },
    { 0x0011u, 0x2803u /* Characteristic                      */, 0x00000801u /* wr     */, 0x0012u, {{0x0010u, (void *)&cyBle_attValuesLen[10]}} },
    { 0x0012u, 0x2083u /* Unlock                              */, 0x00090802u /* wr     */, 0x0012u, {{0x0010u, (void *)&cyBle_attValuesLen[11]}} },
    { 0x0013u, 0x2803u /* Characteristic                      */, 0x00000A01u /* rd,wr  */, 0x0014u, {{0x0010u, (void *)&cyBle_attValuesLen[12]}} },
    { 0x0014u, 0x2084u /* URI Data                            */, 0x00090A04u /* rd,wr  */, 0x0014u, {{0x0012u, (void *)&cyBle_attValuesLen[13]}} },
    { 0x0015u, 0x2803u /* Characteristic                      */, 0x00000A01u /* rd,wr  */, 0x0016u, {{0x0010u, (void *)&cyBle_attValuesLen[14]}} },
    { 0x0016u, 0x2085u /* URI Flags                           */, 0x00090A04u /* rd,wr  */, 0x0016u, {{0x0001u, (void *)&cyBle_attValuesLen[15]}} },
    { 0x0017u, 0x2803u /* Characteristic                      */, 0x00000A01u /* rd,wr  */, 0x0018u, {{0x0010u, (void *)&cyBle_attValuesLen[16]}} },
    { 0x0018u, 0x2086u /* Advertised Tx Power Levels          */, 0x00090A04u /* rd,wr  */, 0x0018u, {{0x0004u, (void *)&cyBle_attValuesLen[17]}} },
    { 0x0019u, 0x2803u /* Characteristic                      */, 0x00000A01u /* rd,wr  */, 0x001Au, {{0x0010u, (void *)&cyBle_attValuesLen[18]}} },
    { 0x001Au, 0x2087u /* Tx Power Mode                       */, 0x00090A04u /* rd,wr  */, 0x001Au, {{0x0001u, (void *)&cyBle_attValuesLen[19]}} },
    { 0x001Bu, 0x2803u /* Characteristic                      */, 0x00000A01u /* rd,wr  */, 0x001Cu, {{0x0010u, (void *)&cyBle_attValuesLen[20]}} },
    { 0x001Cu, 0x2088u /* Beacon Period                       */, 0x00090A04u /* rd,wr  */, 0x001Cu, {{0x0002u, (void *)&cyBle_attValuesLen[21]}} },
    { 0x001Du, 0x2803u /* Characteristic                      */, 0x00000801u /* wr     */, 0x001Eu, {{0x0010u, (void *)&cyBle_attValuesLen[22]}} },
    { 0x001Eu, 0x2089u /* Reset                               */, 0x00090802u /* wr     */, 0x001Eu, {{0x0001u, (void *)&cyBle_attValuesLen[23]}} },
};
